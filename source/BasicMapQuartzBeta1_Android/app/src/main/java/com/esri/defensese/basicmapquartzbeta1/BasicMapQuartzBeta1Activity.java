 ...
 */
public class BasicMapQuartzBeta1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_basic_map_quartz_beta1);
            ...
            public AuthenticationChallengeResponse handleChallenge(AuthenticationChallenge challenge) {
                ...
                switch (challenge.getType()) {
                    case USER_CREDENTIAL_CHALLENGE:
                        ...
                        intent.setClass(BasicMapQuartzBeta1Activity.this, LoginActivity.class);
                        ...
                        try {
                            ...
                            Log.e(BasicMapQuartzBeta1Activity.this.getClass().getSimpleName(), null, ex);
                        }
                        break;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_basic_map_quartz_beta1, menu);
        return true;
    }
